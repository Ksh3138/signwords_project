...
def normalization(input_file, output_file):
    # 1. 파일 오픈
    ...
    #     start_idx = None
    #     for i in range(len(data) - 1):
    #         if has_hand(data[i]) or has_hand(data[i+1]):
    #             prev_points = get_points(data[i])
    #             curr_points = get_points(data[i+1])
    #             state = is_moving(prev_points, curr_points)
    #             print(state)
...
if __name__ == "__main__":
    input_dir = 'C:/Users/DS/Desktop/kimsihyun/Communication_Bridge/ecolink_ai/datas/keypoints_11emer/1_mediapipe'
    output_dir = 'C:/Users/DS/Desktop/kimsihyun/Communication_Bridge/ecolink_ai/datas/keypoints_11emer/2_normalization'
    ...
    for root, dirs, files in os.walk(input_dir):
        for file in files:
            ...
            print(f'{input_file} 처리중')
            normalization(input_file, output_file)



    # input_file='C:/Users/DS/Desktop/kimsihyun/Communication_Bridge/ecolink_ai/trashbin/test.json'
    # output_file='C:/Users/DS/Desktop/kimsihyun/Communication_Bridge/ecolink_ai/trashbin/test_try.json'
    
    # input_file='C:/Users/DS/Desktop/kimsihyun/Communication_Bridge/ecolink_ai/datas/keypoints_18/1_mediapipe/배고프다/KETI_SL_0000001812.json'
    # output_file='C:/Users/DS/Desktop/kimsihyun/Communication_Bridge/ecolink_ai/datas/keypoints_18/2_normalization/배고프다/KETI_SL_0000001812.json'
