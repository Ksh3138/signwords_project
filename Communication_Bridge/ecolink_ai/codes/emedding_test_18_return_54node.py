import torch
import json
from codes.models.st_gcn_18_18words_54node import STGCNModel 
import numpy as np

label_list=['경찰', '교통사고', '구급차', '구해주세요', '깔리다', '배고프다', '병원', '불나다', '숨을 안쉬다', '신고하세요(경찰)', '아빠', '어지러움', '엄마', '연락해주세요', '토하다', '폭발', '피나다', '호흡곤란']
...
def classify(model_path, json_data):
    ...
    # 모델 준비
    model = STGCNModel(in_channels=4, num_class=18)
