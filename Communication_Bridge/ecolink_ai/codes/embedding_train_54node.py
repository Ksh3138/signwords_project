...
from models.st_gcn_18_nwords_54node import STGCNModel #########확인#########
...
class JsonDataset(Dataset):
    ...
    def process_keypoints(self, frames_json): #########확인#########
        num_pose = 12 
        num_hand = 21
        ...
        for frame in frames_json:
            ...
            for i in range(num_hand):
                if i < len(lhand):
                    kp = lhand[i]
                    frame_kps.append([kp['x'], kp['y'], kp['z'], 0])
                else:
                    frame_kps.append([0, 0, 0, 0])
            for i in range(num_hand):
                if i < len(rhand):
...
if __name__ == '__main__':
    root_dir = 'C:/Users/DS/Desktop/kimsihyun/Communication_Bridge/ecolink_ai/final_datas/3_gaussi_8'
    checkpoint_file = 'C:/Users/DS/Desktop/kimsihyun/Communication_Bridge/ecolink_ai/final_datas/checkpoint_8words_54node_trynor_gaussi_addcam.pth'
